...
import { Search, Percent, Shield, TrendingUp, Zap, Layers, BarChart, BookOpen } from "lucide-react";
  ...
  const servicesList = [
    {
      ...
      features: ["Auto & Manual Campaign Split", "ACoS / TACOS Control", "Placement & Bid Bid Adjustments", "Negative Keyword Harvesting"]
    },
    {
      id: "srv-seo",
